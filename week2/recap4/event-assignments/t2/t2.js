...
function displayRestaurants() {
  ...
  sortedRestaurants.forEach(restaurant => {
    ...
    row.addEventListener('click', () => handleRestaurantClick(restaurant, row));

    tableBody.appendChild(row);
  });
}

function handleRestaurantClick(restaurant, row) {
  const allRows = document.querySelectorAll('#restaurants-table tr');
  ...
  document.getElementById('restaurant-postal').textContent = `Postal Code: ${restaurant.postalCode}`;
  document.getElementById('restaurant-city').textContent = `City: ${restaurant.city}`;
  document.getElementById('restaurant-phone').textContent = `Phone: ${restaurant.phone}`;
  document.getElementById('restaurant-company').textContent = `Company: ${restaurant.company}`;
...
window.addEventListener('DOMContentLoaded', displayRestaurants);
